...
! function(window) {
	...
	Slider.prototype.init = function() {
		...
		_this.itemNums = options.itemLength;
		//_this.itemNums = _this.$wrapper.find('.' + options.slideClass).length;
		console.log("vue:" + this.itemNums);
	...
	Slider.prototype.autoPlay = function() {
		...
		_this.autoPlayTimer = setInterval(function() {
			...
			if(_this.index >= _this.itemNums) {
				...
				_this.setTranslate(_this.options.speed, -(++_this.index * _this.$wrapper.width()-_this.$wrapper.width()));
			}
